@extends('layouts.app', ['activePage' => 'notifications', 'title' => 'Instructors', 'navName' => 'Instructors', 'activeButton' => 'laravel'])
                                        ...
                                        <div class="">
                                            <form action="edit-student" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-12  col-md-4">
                                                        <label for="year">Semester</label>
                                                        <select id="up_semester" name="semester" class="form-control">
                                                            <option value="one"> one</option>
                                                            <option value="two"> two</option>
                                                            <option value="three"> three</option>
                                                            <option value="four"> four</option>
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-12  col-md-4">
                                                        <label for="year">Course</label>
                                                        <select id="up_course" name="course" class="form-control">
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-xs-12 col-sm-12 ">
                                                    <label for="phone">Phone</label>
                                                    <input type="tel" id="up_phone" name="phone" class="form-control" required>
                                                </div>
                                                <div class="form-group col-xs-12 col-sm-12 ">
                                                    <label for="email">Email</label>
...
<script>
    ...
    function updateBranch(id,student_name,phone,email,year,semester,course) {
        $('#updateId').val(id)
        $('#UpdatedName').val(name);
        $('#up_semester').val(semester)
        z =`<option value="${year}" selected>${year}</option>`;
        $('#up_year').append(z)
        v =`<option value="${course}" selected>${course}</option>`;
        $('#up_course').append(v)
                    ...
                    "data": function (data) {
                        return `<div class="btn-group "style="cursor: pointer">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start" id="bottomStart"> 
                                        ...
                                        <a class="dropdown-item" onclick="updateBranch('${data.id}','${data.student_name}','${data.phone}','${data.email}','${data.year}','${data.semester}','${data.course}')" href="#">
                                            edit
                                        </a> 
                                    </div>
                                </div>
